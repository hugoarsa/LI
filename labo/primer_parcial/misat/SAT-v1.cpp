...
/*-------------------------------------------------------------------------------------------------------------
  MEJORA DE V1: cuando propagemos un elemento en particular solo evaluar las clausulas susceptibles a que 
  este elemento a propagar haya podido producir algun cambio
  
  decision: si un literal es positivo no hemos de mirar en los que este tambien este en positivo pues ya 
  estan resueltas siempre comprobamos el valor contrario para posible propagacion o conflicto 

  estucturas de datos necesarias: lista de todas las clausulas donde esta en positivo o en negativo
  ---------------------------------------------------------------------------------------------------------------*/
