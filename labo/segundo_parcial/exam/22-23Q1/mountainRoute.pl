...
unPaso(Cost, [X1, Y1], [X2, Y1]) :- X2 is X1 - 1, topoMap(M), nth1(X2, M, Row), nth1(Y1, Row, E), E \= x, costPos(E, Cost).
unPaso(Cost, [X1, Y1], [X2, Y1]) :- X2 is X1 + 1, topoMap(M), nth1(X2, M, Row), nth1(Y1, Row, E), E \= x, costPos(E, Cost).
unPaso(Cost, [X1, Y1], [X1, Y2]) :- Y2 is Y1 - 1, topoMap(M), nth1(X1, M, Row), nth1(Y2, Row, E), E \= x, costPos(E, Cost).
unPaso(Cost, [X1, Y1], [X1, Y2]) :- Y2 is Y1 + 1, topoMap(M), nth1(X1, M, Row), nth1(Y2, Row, E), E \= x, costPos(E, Cost).
