...
path( NumCitiesRemainingToBeVisited, RemainingKm, CurrentCity, CitiesAlreadyVisited, [CurrentCity1|Path] ):-
    %NumCitiesRemainingToBeVisited > 0, %may be unnecesary
    road1( CurrentCity-CurrentCity1, K ),
    \+ member(CurrentCity1, CitiesAlreadyVisited),
    RemainingKm >= K,
    NextNumCitiesRemaining is NumCitiesRemainingToBeVisited - 1,
    NextRemainingKm is RemainingKm - K,
    path(NextNumCitiesRemaining, NextRemainingKm, CurrentCity1, [CurrentCity1 | CitiesAlreadyVisited], Path).
